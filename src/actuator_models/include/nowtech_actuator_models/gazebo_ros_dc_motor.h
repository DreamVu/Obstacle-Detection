...
#include <nowtech_actuator_models/motorModelConfig.h>
...
namespace gazebo {
  ...
  class GazeboRosMotor : public ModelPlugin {
    ...
    private:
      ...
      nowtech_actuator_models::motorModelConfig current_config_;
      ...
      // Reconfiguration
      boost::shared_ptr<dynamic_reconfigure::Server<nowtech_actuator_models::motorModelConfig>> dynamic_reconfigure_server_;
      boost::recursive_mutex reconf_mutex_;
      bool notify_server_;
      void reconfigureCallBack(const nowtech_actuator_models::motorModelConfig &config, uint32_t level);
      ...
      void brakeCommandCallBack( const std_msgs::Bool::ConstPtr& cmd_msg );
